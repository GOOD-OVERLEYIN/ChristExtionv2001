    ...
    def __init__(self,
        ...
        if not useragents:
            useragents: List[str] = [
                ...
                'Safari/537.36',
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/206550001 Firefox/69.0',
            ...
            if self._proxies:
                ...
                with Tools.dgb_solver(self._target.human_repr(), randchoice(self._useragents), pro.asRequest()) as ss:
                    for _ in range(min(self._rpc, 1000)):
                        sleep(min(self._rpc, 1000) / 65534)
